...
class MotionSequence(Node):
    def __init__(self):
        ...
        # New subscription to pause path following during item collection
    ...
    def generate_path(self):
        ...
        for i in range(3):
            ...
            targets.append(Pose2D(x=2.0, y=y_offset - 0.5, theta=-math.pi/2))      
    ...
    def start_stop_callback(self, msg):
        try:
            ...
            elif command == "manual" and not (self.obstacle_avoidance or self.obstacle_detected or self.is_collecting):
